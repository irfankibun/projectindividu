...
<head>
	...
	include 'config.php';
	?>
	<title>RENTAL PLAYSTATION 4</title>
...
<body>
	<div class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="##" class="navbar-brand">RENTAL PLAYSTATION 4</a>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					while($q=mysql_fetch_array($periksa)){	
						if($q['jumlah']<=3){			
							echo "<div style='padding:5px' class='alert alert-warning'><span class='glyphicon glyphicon-info-sign'></span> Stok  <a style='color:red'>". $q['nama']."</a> yang tersisa sudah kurang dari 3</div>";	
						}
					}
					?>
				</div>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			...
			<li><a href="barang.php"><span class="glyphicon glyphicon-briefcase"></span>  Data Console</a></li>
			<li><a href="barang_laku.php"><span class="glyphicon glyphicon-briefcase"></span>  Entry Rental</a></li>        												
